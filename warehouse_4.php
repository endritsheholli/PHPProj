				...
				<div class="shell">
					...
					<div id="top-nav">
						<ul>
							...
							<li>
								<a href="Sign In.php" title="Sign In">
									<span>Sign In</span>
								</a>
							</li>
						</ul>
			...
			<div id="footer">
					...
					<div class="shell">
						<div class="box post-box">
							...
							<div class="box-entry">
								...
								<p>You can be confident when you're shopping online with SomStore. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.Our Secure online shopping website locks all critical information passed from you to us,such as personal information, in an encrypted envelope, making it extremely difficult for this information to be intercepted. </p>
								<div class="cl">&nbsp;</div>
							</div>
						</div>
				...
				<div class="copy">
					<div class="shell">
						...
						<p>&copy; buki.com <a href="index.php"><i><font color="fefefe"> Welcome To Buki Online Shopping Site </font></i></a></p>
						<div class="cl">&nbsp;</div>
						Copyright © 2017 buki.com All rights reserved.
					</div>
				</div>
			</div>		
			<div class="shout_box">
